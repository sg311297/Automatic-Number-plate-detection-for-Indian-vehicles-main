...
import pytesseract
import re
pytesseract.pytesseract.tesseract_cmd = r'C:\New folder\Python3\pytesser\tesseract.exe'  # your path may be different
#pytesseract.pytesseract.tesseract_cmd = 'C:/Tesseract-OCR/tesseract.exe'  # your path may be different
...
#img = cv2.imread('./images/cars8.png')
# img=cv2.imread(img)
